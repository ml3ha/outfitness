...
$cancelUrl= "http://".$hostName."/".$appName."/Checkout-REST-php-master/cancel.php";
$payUrl = "http://".$hostName."/".$appName."Checkout-REST-php-master/pay.php";
$placeOrderUrl = "http://".$hostName."/".$appName."/Checkout-REST-php-master/placeOrder.php";
